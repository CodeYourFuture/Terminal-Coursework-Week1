...
- [x] The tab key - HOWEVER, YOU NEED TO HAVE THE SOFTER INSTALLED FOR IT TO WORK (DOESN'T WORK IN MY TERMINAL AT THE MOMENT).
- [ ] ctrl+c
- [ ] ctrl+shift or cmd+shift
- [ ] The enter key
- [ ] The escape key
...
according to the course, it would be an "Option" - if -R is comparable.
